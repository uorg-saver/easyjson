# easyjson [![Build Status](https://github.com/uorg-saver/easyjson/actions/workflows/easyjson.yml/badge.svg)](https://github.com/uorg-saver/easyjson/actions/workflows/easyjson.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/uorg-saver/easyjson)](https://goreportcard.com/report/github.com/uorg-saver/easyjson)
...
```sh
# for Go < 1.17
go get -u github.com/uorg-saver/easyjson/...
```
#### or
```sh
# for Go >= 1.17
go get github.com/uorg-saver/easyjson && go install github.com/uorg-saver/easyjson/...@latest
```
### Run:
```sh
...
Please see the [GoDoc](https://godoc.org/github.com/uorg-saver/easyjson)
...
listing](https://godoc.org/github.com/uorg-saver/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/uorg-saver/easyjson/buffer)
